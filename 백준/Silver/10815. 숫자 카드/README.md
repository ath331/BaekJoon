...
### 버퍼를 줄여서 속도를 빠르게 하는 방법 사용

ios_base::sync_with_stdio( false ); : c의 stdio와 cpp의 iostream 연결을 풀어줌으로서 c++만의 독립적인 버퍼를 사용. ( C입출력문과 C++입출력문을 혼합하여 사용할 수 없게됨 )

cin.tie( nullptr );  :  cout과 cin의 묶음을 풀어준다.
